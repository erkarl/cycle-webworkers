...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(drivers) {
	  return {
	    DOM: _rx2.default.Observable.of('').map(function (someVal) {
	      return (0, _DOM.div)([(0, _DOM.p)('Cycle WebWorkers')]);
	    })
	  };
	}
